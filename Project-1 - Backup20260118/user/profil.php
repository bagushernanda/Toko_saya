        ...
        <div class="profile-grid">
            ...
            <aside class="card">
                ...
                <div class="profile-img-section">
                    ...
                    <img src="data:image/jpeg;base64,<?php echo base64_encode($detail['foto_profil']); ?>" 
                        style="width: 120px; height: 120px; border-radius: 50%; object-fit: cover; border: 4px solid #ff4757; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
                    <?php else: ?>
                    <i class="fa-solid fa-circle-user" style="font-size: 120px; color: #ced4da;"></i>
                <?php endif; ?>
